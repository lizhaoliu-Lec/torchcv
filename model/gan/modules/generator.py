...
class ResNetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_type=None, use_dropout=False, n_blocks=6,
...
class ResnetBlock(nn.Module):
    ...
    def __init__(self, dim, padding_type, norm_type, use_dropout, use_bias):
        ...
        self.conv_block = self.build_conv_block(dim, padding_type, norm_type, use_dropout, use_bias)

    def build_conv_block(self, dim, padding_type, norm_type, use_dropout, use_bias):
        ...
        conv_block += [nn.Conv2d(dim, dim, kernel_size=3, padding=p, bias=use_bias),
                       ModuleHelper.BatchNorm2d(norm_type=norm_type)(dim), nn.ReLU(True)]
        if use_dropout:
...
class UNetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, ngf=64, norm_type=None, use_dropout=False):
        ...
        unet_block = UnetSkipConnectionBlock(ngf * 8, ngf * 8, input_nc=None, submodule=None, norm_type=norm_type,
