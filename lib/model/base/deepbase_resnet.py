...
class DeepbaseResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.conv3 = nn.Conv2d(64, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)
...
def deepbase_resnext50_32x4d(pretrained=False, progress=True, **kwargs):
...
def deepbase_resnext101_32x8d(pretrained=False, progress=True, **kwargs):
